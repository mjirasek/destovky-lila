...
This is a trimmed Lila-based experiment for Destovky. It keeps the Lichess/Lila
server, lobby, account, game, and frontend source structure, while omitting
large optional runtime assets that are not needed for early infrastructure work
(`public/lifat/nnue`, `public/lifat/vosk`, and `public/lifat/background`).

The upstream Lila README follows.
